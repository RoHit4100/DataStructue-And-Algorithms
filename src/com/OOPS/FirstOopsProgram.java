...
/*
    ...
    Objects are characterized by three essential properties: state, identity, and behavior.
        ...
        2. The identity of an object distinguishes one object from another.
           It is useful to think of an object’s identity as the place where its value is stored in memory.
        3. The behavior of an object is the effect of data-type operations.
...
public class FirstOopsProgram {
    public static void main(String[] args) {
       Human rohit = new Human(22, 100000000, "Rohit Udamale");
        System.out.println(rohit.age);  // rohit.age == value of the object
    }
}
