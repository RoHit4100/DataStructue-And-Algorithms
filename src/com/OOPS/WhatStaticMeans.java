...
/*
    ...
    In fact, you can access a non-static member in a static context by specifying the object reference explicitly :
        ...
        public static void main(String[] args) {
            ...
            rohit.message = "rohit's message";
            Human.display(rohit);
        }

    A static method can call only other static methods and cannot call a non-static method from it.
    A static method can be accessed directly by the class name and doesn't need any object
    A static method cannot refer to "this" or "super" keywords anyway.
    ...
    As soon as the UseStatic class is loaded, all of static statements are run. First, a is set to 3,
...
class UseStaticFunctionality{
    static int a;
    static int b  = 10;

    static void printAllValue(int x) {
    ...
    static {
        System.out.println("Static is called once");
        a = b + 10;
    }
}
public class WhatStaticMeans {
    ...
    public static void main(String[] args) {
        UseStaticFunctionality.printAllValue(5);
        Student rohit = new Student(21, 80f);
        System.out.println(rohit.age);
        Student a = new Student(13, 66);
