...
/*
    ...
    1. By default, functions are public and abstract in interface.
    2. variables are final and static by default in interface.
...
(especially through the use of instance variables), but an interface cannot.
    ...
    1. A class can implement more than one interface. By contrast, a class can only inherit a single superclass
...
a static and non-extensible classing environment. Inevitably in a system like this, functionality gets pushed up higher
...
interface Engine extends Brake{
    int price = 50000;
    void startEngine();
    void stopEngine();
}
...
class PetrolCar implements MediaPlayer, Engine {
    ...
    @Override
    public void push() {
        System.out.println("Pushing break");
    }
